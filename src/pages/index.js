        ...
        <Row className="row" style={{minHeight: "100%", margin:0}}>
            ...
            <Col className="landing-col"> {/* Planet */}
                <div>
                    ...
                    <p>
                        &emsp;I am a software engineer currently attending Rochester Institute of Technology, however I am also a musician, visual artist, and lifelong learner. I want to leave the world a better place, by whatever means are available to me. I aim to create software and art that brings people together.
                        <br />
